# [SOLVED] The-Problem-Of-Getting-The-Primary-Monitor-Infos-With-Screen
...
>
> ### ➡️ [CLICK HERE TO VIEW THE FULL FIX GUIDE](https://techfixdocs.my.id/the-problem-of-getting-the-primary-monitor-infos-with-screen)
>
...
Use try-except block to catch any exceptions raised by the get_monitors() function, and ensure that the primary monitor is correctly identified before calculating coordinates.
...
👉 **[Go to ErrorFix Hub Full Article](https://techfixdocs.my.id/the-problem-of-getting-the-primary-monitor-infos-with-screen)**
